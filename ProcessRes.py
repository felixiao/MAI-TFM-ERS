...
CompareResults('Yelp_RESULT_TABLE.csv','./Result/Yelp',['NRT','Att2Seq','PETER','PETER+'])
CompareResults('MT_RESULT_TABLE.csv','./Result/Amazon/MoviesAndTV',['NRT','Att2Seq','PETER','PETER+'])
